...
@can('access_departments')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('departments.*') ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="c-sidebar-nav-icon bi bi-journal-bookmark" style="line-height: 1;"></i> Departments
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('departments.*') ? 'c-active' : '' }}" href="{{ route('departments.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-collection" style="line-height: 1;"></i> List Departments
                </a>
            </li>
            
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" data-toggle="modal" data-target="#departmentCreateModal">
                <i class="c-sidebar-nav-icon bi bi-journal-plus" style="line-height: 1;"></i> Create Departments
            </a>
        </li>
...
@can('access_approval_types')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('approval_types.*') || request()->routeIs('approval_rules.*') || request()->routeIs('approval_rule_users.*') ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="c-sidebar-nav-icon bi bi-journal-bookmark" style="line-height: 1;"></i> Approval
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('approval_types.*') ? 'c-active' : '' }}" href="{{ route('approval_types.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-collection" style="line-height: 1;"></i> Approval Types
                </a>
            </li>
        </ul>
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('approval_rules.*') ? 'c-active' : '' }}" href="{{ route('approval_rules.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-collection" style="line-height: 1;"></i> Approval Rules
                </a>
            </li>
        </ul>
    </li>
...
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown 
    {{ request()->routeIs('master_budget.*') ? 'c-show' : '' }}">
    
    <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
        <i class="c-sidebar-nav-icon bi bi-journal-bookmark" style="line-height: 1;"></i> Master Budget
    </a>

    <ul class="c-sidebar-nav-dropdown-items">
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('master_budget.*') ? 'c-active' : '' }}" 
               href="{{ route('master_budget.index') }}">
                <i class="c-sidebar-nav-icon bi bi-collection" style="line-height: 1;"></i> List Master Budget
            </a>
        </li>
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('master_budget.*') ? 'c-active' : '' }}" 
               href="{{ route('master_budget.create') }}">
                <i class="c-sidebar-nav-icon bi bi-plus-circle" style="line-height: 1;"></i> Create Master Budget
            </a>
        </li>
    </ul>
</li>
